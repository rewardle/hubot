...
RUN npm install -g hubot yo generator-hubot coffeescript@1.12.7 hubot-slack
...
# Create hubot
RUN yo hubot --name rewardlehubot --description "Rewardle Hubot" --adapter slack --defaults
